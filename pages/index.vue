...
<template>
  ...
  <div class="px-4 py-12 font-sans">
    <div class="max-w-[90%] max-sm:max-w-sm mx-auto">
  ...
  <div class="max-w-5xl mx-auto font-[sans-serif] p-4">
    <div class="text-center">
      <h2 class="text-gray-800 text-4xl font-bold">Pricing Plans</h2>
    </div>

    <div class="flex mx-auto bg-gray-100 rounded-full max-w-[250px] p-1 mt-8">
      <button class="text-white w-full text-sm bg-blue-500 py-2 px-4 rounded-full">
        Monthly</button>
      <button
          class="w-full text-sm py-2 px-4 rounded-full">
        Yearly</button>
    </div>

    <div class="grid lg:grid-cols-3 md:grid-cols-2 max-lg:gap-8 mt-8 max-md:max-w-sm max-md:mx-auto">

      <div class="bg-gray-100 rounded-3xl overflow-hidden p-8">
        <div class="text-left">
          <h4 class="text-gray-800 font-semibold text-2xl">Starter</h4>
          <p class="text-gray-600 text-sm mt-2">Ideal for individuals.</p>
          <h3 class="text-gray-800 font-semibold text-2xl mt-4">$5.00<sub class="text-sm font-medium text-gray-600 ml-1">/ Month</sub></h3>
          <button type="button" class="w-full mt-8 px-5 py-2.5 text-sm bg-blue-600 text-white hover:bg-blue-700 rounded-full">Buy Now</button>
        </div>

        <div class="mt-8">
          <h4 class="text-gray-800 font-semibold text-lg mb-4">Plan Included</h4>
          <ul class="space-y-4">
            <li class="flex items-center text-sm text-gray-600">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" class="mr-3 bg-blue-100 fill-blue-600 rounded-full p-[3px]" viewBox="0 0 24 24">
      ...
      <div class="bg-white lg:scale-[1.05] shadow-[0_2px_40px_-4px_rgba(93,96,127,0.2)] rounded-3xl overflow-hidden p-8">
        <div class="text-left">
          <h4 class="text-gray-800 font-semibold text-2xl">Professional</h4>
          <p class="text-gray-600 text-sm mt-2">Ideal for small Teams.</p>
          <h3 class="text-gray-800 font-semibold text-2xl mt-4">$8.00<sub class="text-sm font-medium text-gray-600 ml-1">/ Month</sub></h3>
          <button type="button" class="w-full mt-8 px-5 py-2.5 text-sm bg-blue-600 text-white hover:bg-blue-700 rounded-full">Buy Now</button>
        </div>
      ...
      <div class="bg-gray-100 rounded-3xl overflow-hidden p-8">
        <div class="text-left">
          <h4 class="text-gray-800 font-semibold text-2xl">Enterprise</h4>
          <p class="text-gray-600 text-sm mt-2">Ideal for larger Teams.</p>
          <h3 class="text-gray-800 font-semibold text-2xl mt-4">$20.00<sub class="text-sm font-medium text-gray-600 ml-1">/ Month</sub></h3>
          <button type="button" class="w-full mt-8 px-5 py-2.5 text-sm bg-blue-600 text-white hover:bg-blue-700 rounded-full">Buy Now</button>
        </div>
